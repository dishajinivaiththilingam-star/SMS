      ...
      <div className="ml-[250px] w-full min-h-screen bg-gray-100">
        ...
        <div className="p-10">
          ...
          <div className="bg-white rounded-2xl shadow p-8 mb-8">
            ...
            <h2 className="text-2xl font-bold text-red-700 mb-6 border-b pb-3">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-semibold">
                ...
                {student.agree_discontinue_fee
                  ? "Student Accepted Institute Rules"
                  : "Student Did Not Accept Rules"}
